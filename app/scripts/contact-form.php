<?php
    ...
    $body.= '<div style="padding:bottom:5px;border-bottom:1px solid #d9dcdd;margin-bottom:5px;"><span><strong style="color:#F3600C;">Last Name:</strong></span> <span>'.$_POST['contact0-form-last-name'].'</span></div>';
